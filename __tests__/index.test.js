import SbataShopClient from '../src/index';
...
test('api structure', () => {
	const api = new SbataShopClient(API_CREDENTIALS);
...
test('ajax structure', () => {
	const api = new SbataShopClient(AJAX_CREDENTIALS);
...
test('static methods', () => {
	expect(typeof SbataShopClient.authorize).toBe('function');
	expect(typeof SbataShopClient.authorizeInWebStore).toBe('function');
});
